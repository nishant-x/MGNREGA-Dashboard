...
export const metadata: Metadata = {
  ...
  description: "An interactive MGNREGA performance dashboard built with Next.js and Recharts. View district-wise data, charts, and insights with auto location detection.",
};
